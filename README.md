...
| Script | O que faz |
|---|---|
| `scrape_posts.py` | Scrape do blog: constrói/atualiza `posts.json` e `posts/*.md` |
| `download_all.py` | Download de todos os arquivos (16 workers, multi-serviço) |
...
python3 scrape_posts.py --label "https://www.hominiscanidae.org/search/label/NOME"
